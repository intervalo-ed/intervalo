...
linear_new = [
    {
        ...
        "correct_index": 2,
        "has_math": True,
        "feedback_correct": "Como $a = 3 > 0$, la función $f(x) = 3x - 7$ es creciente en todo $\\mathbb{R}$.",
    ...
    },
    {
        ...
        "correct_index": 0,
        "has_math": True,
        "feedback_correct": "El coeficiente $a = -2 < 0$ indica que la función es decreciente en todo $\\mathbb{R}$.",
    ...
    },
    {
        ...
        "correct_index": 1,
        "has_math": True,
        "feedback_correct": "Si $a < 0$, cada aumento de $x$ produce una disminución de $f(x)$: la función es decreciente.",
...
quadratic_new = [
    {
        ...
        "correct_index": 1,
        "has_math": True,
        "feedback_correct": "El vértice está en $x = 2$. Como la parábola abre hacia arriba ($a > 0$), decrece en $(-\\infty, 2]$.",
    ...
    },
    {
        ...
        "correct_index": 3,
        "has_math": True,
        "feedback_correct": "El vértice está en $x = 3$. Como la parábola abre hacia abajo ($a < 0$), crece en $(-\\infty, 3]$.",
    ...
    },
    {
        ...
        "correct_index": 0,
        "has_math": True,
        "feedback_correct": "En forma canónica $f(x) = (x-1)^2 + 2$, el vértice es $(1, 2)$. Como abre hacia arriba, crece en $[1, +\\infty)$.",
...
polynomial_new = [
    {
        ...
        "correct_index": 0,
        "has_math": True,
        "feedback_correct": "$f(x) = x^3$ es estrictamente creciente en todo $\\mathbb{R}$: si $x_1 < x_2$ entonces $x_1^3 < x_2^3$.",
    ...
    },
    {
        ...
        "correct_index": 2,
        "has_math": True,
        "feedback_correct": "$f(x) = -x^3$ es decreciente en todo $\\mathbb{R}$: multiplicar por $-1$ invierte el comportamiento de $x^3$.",
    ...
    },
    {
        ...
        "correct_index": 3,
        "has_math": True,
        "feedback_correct": "Todo polinomio de grado par $\\geq 2$ tiene al menos un extremo local (un máximo o mínimo), por lo que no puede ser siempre creciente.",
...
exponential_new = [
    {
        ...
        "correct_index": 3,
        "has_math": True,
        "feedback_correct": "Cuando la base $0 < a < 1$, la función exponencial es decreciente: a medida que $x$ crece, $a^x$ se acerca a cero.",
    ...
    },
    {
        ...
        "correct_index": 1,
        "has_math": True,
        "feedback_correct": "$f(x) = 2^x$ es creciente en todo $\\mathbb{R}$: cuanto mayor sea $x$, mayor es $2^x$.",
    ...
    },
    {
        ...
        "correct_index": 0,
        "has_math": True,
        "feedback_correct": "$(1/3)^x$ tiene base $1/3 < 1$, así que es decreciente.",
...
logarithmic_new = [
    {
        ...
        "correct_index": 0,
        "has_math": True,
        "feedback_correct": "$\\ln(x)$ es estrictamente creciente en todo su dominio $(0, +\\infty)$: si $x_1 < x_2$ entonces $\\ln(x_1) < \\ln(x_2)$.",
    ...
    },
    {
        ...
        "correct_index": 2,
        "has_math": True,
        "feedback_correct": "Cuando $0 < b < 1$, $\\log_b(x)$ es decreciente: valores mayores de $x$ producen logaritmos menores.",
    ...
    },
    {
        ...
        "correct_index": 1,
        "has_math": True,
        "feedback_correct": "$\\log_{0.5}(x)$ tiene base $0.5 < 1$, así que es decreciente.",
...
rational_new = [
    {
        ...
        "correct_index": 1,
        "has_math": True,
        "feedback_correct": "$f(x)=1/x$ es decreciente tanto en $(-\\infty,0)$ como en $(0,+\\infty)$, en cada tramo por separado.",
    ...
    },
    {
        ...
        "correct_index": 2,
        "has_math": True,
        "feedback_correct": "$f(x) = (x+1)/(x-1)$ es decreciente en $(-\\infty, 1)$ y también en $(1, +\\infty)$.",
    ...
    },
    {
        ...
        "correct_index": 0,
        "has_math": True,
        "feedback_correct": "$f(x) = 1/(x-2)$ es decreciente en $(2, +\\infty)$: a medida que $x$ aumenta, el denominador crece y la fracción disminuye.",
    ...
    },
    {
        ...
        "correct_index": 3,
        "has_math": True,
        "feedback_correct": "En la gráfica se ve claramente que ambas ramas bajan de izquierda a derecha: la función decrece en cada tramo de su dominio.",
...
trigonometric_new = [
    {
        ...
        "correct_index": 3,
        "has_math": True,
        "feedback_correct": "$\\sin(x)$ alcanza su máximo en $\\pi/2$ y su mínimo en $3\\pi/2$. Decrece en $[\\pi/2, 3\\pi/2]$.",
    ...
    },
    {
        ...
        "correct_index": 0,
        "has_math": True,
        "feedback_correct": "$\\cos(x)$ tiene su mínimo en $\\pi$ ($\\cos(\\pi)=-1$) y sube hasta $\\cos(2\\pi)=1$. Crece en $[\\pi, 2\\pi]$.",
    ...
    },
    {
        ...
        "correct_index": 2,
        "has_math": True,
        "feedback_correct": "En $[0, 4\\pi]$ hay dos períodos completos. El seno cambia de creciente a decreciente una vez por período: en $x = \\pi/2$ y en $x = 5\\pi/2$. Total: 2 veces.",
    ...
    },
    {
        ...
        "correct_index": 1,
        "has_math": True,
        "feedback_correct": "En la gráfica se ve que la curva sube desde $-\\pi/2$ hasta $\\pi/2$, pasando por el máximo $\\sin(\\pi/2)=1$.",
