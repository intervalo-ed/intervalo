...
UNIVERSITY_COLOR = {
    ...
    "UNC": "#3E9C93", "UNR": "#D742A0", "UNL": "#29CBD9", "UNT": "#9AA7B8",
...
def _uni_chip(sigla: str) -> str:
    ...
    translúcido, o gris si la universidad entró por «Otra». Sin excepciones:
    las tres tintas salen del mismo color, igual que en el front."""
