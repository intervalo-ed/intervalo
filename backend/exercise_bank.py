    ...
    ("quadratic", "vocabulary"): [
        {
            ...
            "options": ["$f(x) = 2x^2 - x + 1$", "$f(x) = 4x - 7$", "$f(x) = 2^x$", "$f(x) = \\sqrt{x}$"],
            "correct_index": 0,
            "has_math": True,
    ...
    ("polynomial", "vocabulary"): [
        {
            ...
            "options": ["$f(x) = x^3 - 2x + 5$", "$f(x) = x^2 + 1$", "$f(x) = 4x - 1$", "$f(x) = x^4$"],
            "correct_index": 0,
            "has_math": True,
    ...
    ("exponential", "vocabulary"): [
        {
            ...
            "options": ["$f(x) = 5 \\cdot 2^x$", "$f(x) = x^5$", "$f(x) = 3x + 1$", "$f(x) = \\ln(x)$"],
            "correct_index": 0,
            "has_math": True,
    ...
    ("logarithmic", "vocabulary"): [
        {
            ...
            "options": ["$f(x) = \\log_2(x)$", "$f(x) = 2^x$", "$f(x) = x^2$", "$f(x) = 1/x$"],
            "correct_index": 0,
            "has_math": True,
    ...
    ("trigonometric", "vocabulary"): [
        {
            ...
            "options": ["$f(x) = \\operatorname{sen}(x)$", "$f(x) = e^x$", "$f(x) = x^3$", "$f(x) = \\ln(x)$"],
            "correct_index": 0,
            "has_math": True,
    ...
    ("rational", "vocabulary"): [
        {
            ...
            "options": ["$f(x) = \\dfrac{x+1}{x-2}$", "$f(x) = x^2 - 1$", "$f(x) = 3^x$", "$f(x) = \\sqrt{x}$"],
            "correct_index": 0,
            "has_math": True,
