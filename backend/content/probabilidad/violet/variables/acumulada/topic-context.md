...
- **`graph_view` no necesita ser cuadrado** en estos 3 casos (la regla de aspecto 1:1 de la sección Gráficos de `authoring-context.md` es para pendientes de `analisis`): elegir un rango de $y$ que deje margen arriba/abajo de $[0,1]$ (densidad) o de la altura $h$ (rampa), y de $x$ que cubra el dominio con margen para ver el comportamiento antes/después.
