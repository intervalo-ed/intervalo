...
|----------|--------|-------|--------|
| `white` | `aritmetica` | divisibilidad, fracciones, potenciación, radicales, notación (científica), absoluto (valor absoluto), propiedades (algebraicas), logaritmos | Visible |
