...
// Separaciones entre centros de nodos. Ajustadas para un árbol compacto
// (estilo Minecraft): el tile mide 44px, así que con COL_W=60 el hueco
// horizontal queda en ~16px y con ROW_H=54 el vertical en ~10px.
