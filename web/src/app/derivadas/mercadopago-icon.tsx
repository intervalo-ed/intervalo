...
//
// **De dónde sale el dibujo.** El trazo es el oficial de Simple Icons (CC0), que
// viene monocromo y de línea: un anillo ovalado con el apretón de manos adentro.
// La versión a color se arma acá recortando ese mismo trazo con la elipse
// INTERNA del propio logo (`rx 11.537 · ry 7.293`, que salen de su última curva),
// lo que borra el anillo y deja solo el apretón. Encima va la elipse externa
// (`rx 12 · ry 8.2065`, medida con getBBox sobre el trazo). O sea que la forma es
// la geometría de la marca y no un dibujo parecido.
//
...
// color cambiado deja de ser reconocible, que es justo lo único que este ícono
// tiene que lograr. Los dos colores están fijos y la combinación se eligió
// mirando el botón a 19px (ver los mockups): óvalo blanco para separarlo del
// dorado, y el celeste adentro, que es donde se lee.
//
...
/** El azul de marca de Mercado Pago. */
const CELESTE = "#00A9E0"
...
export function MercadoPagoIcon({
  ...
  // El recorte necesita un id, y el ícono puede aparecer más de una vez en la
  // misma pantalla: con un id fijo, el segundo se recortaría con el del primero.
  const recorte = useId()
  return (
    <svg
