  ...
  return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <TileDestacada
        ...
        explicacion="Cada cafecito que le invitan a tu universidad multiplica un rato la experiencia de todos los que estudian ahí, también la tuya. Esto es cuánta te tocó de más por eso — lo que ganaste antes de que empezáramos a llevar la cuenta no está."
