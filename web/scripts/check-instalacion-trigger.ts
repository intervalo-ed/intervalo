...
// consume el cooldown compartido— la copia siguió contestando lo de antes y este
// chequeo siguió en verde midiendo un ladder que ya no era el del producto. Una
